...
We have provided an example output from GARP in a "BestSubsets". We can sum the best subset model outputs into a single summed raster using the `sumRasters` function:
```{r comment = "R>"}
...
=======
modelRule <- FindModRule(pathA = "~/runs/", pathB = "~/BestSubsets/")
...
=======
rangelogit <- ExtractRules("~/RuleSets.txt", 
>>>>>>> a50045bd9dfc6a3b128bcd585bc85194afa8d4f7
                           table = modelRule, 
                           pathA = "~/resampled/", 
                           pathB = "~/runs/",
...
```{r eval = FALSE, comment = "R>"}
write.csv(rangelogit, "~/RangeLogit.csv") 
```
...
```{r eval = FALSE, comment = "R>"}
MedMinMax <- getMedMinMax(pathA = "~/RangeLogit.csv", 
                          pathB = "~/resampled/") 
```
...
=======
PreNo <- TotPresRules(file = "~/RuleSets.txt", 
>>>>>>> a50045bd9dfc6a3b128bcd585bc85194afa8d4f7
                      table = modelRule, 
                      pathA = "~/resampled/", 
                      pathB = "~/runs/", 
...
=======
prevalence <- Prevalence(pathA = "~/RuleSets.txt", 
                         pathB = "~/runs/", num = 10)
>>>>>>> a50045bd9dfc6a3b128bcd585bc85194afa8d4f7
```
...
```{r eval = FALSE, comment = "R>"}
write.csv(UnimportanceIndex,"~/UnimportanceIndex.csv")
```

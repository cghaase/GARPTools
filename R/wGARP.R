...
#'
#' \code{wGARP} Returns the Wilcoxon test statistic of the best model subset output from GARP. When using discrete values, such as the number of models agreeing on predicted presence location, the Wilcoxon test statistic equates the AUC.
#'
...
#'   wGARP(n = 10, x = r, points = SpatialPoints(hs[,1:2]))
#'
#' @import raster
#' @import sp
#'
